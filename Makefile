...
$(APP) cli:
  ...
  install                          Developer install $(APP) locally
                                   (only   needed once)
  ...
  prep_large                       Show files with greater than default
                                   limit with `make prep_large` or
...
prep_large:
	python3 examples/print_large_files.py $(LIMIT) $(EXT)
